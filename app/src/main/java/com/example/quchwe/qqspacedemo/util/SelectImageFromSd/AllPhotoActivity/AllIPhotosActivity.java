...
import com.example.quchwe.qqspacedemo.util.SelectImageFromSd.ImageSelectActivity.ImageDirectoryActivity;
...
public class AllIPhotosActivity extends BaseActivity implements View.OnClickListener,SeletPhotoContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        limit = getIntent().getIntExtra(SELECT_LIMITS,-1);
...
//        setSlectPicturePath();
        ...
        intent.putExtra(PreviewPhotoPagerActivity.LIMIT,limit);
